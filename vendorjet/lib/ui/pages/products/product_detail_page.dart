    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: t.edit,
            onPressed: () => _showEditPlaceholder(context),
          ),
        ],
      ),
      body: FutureBuilder<Product?>(
        ...
        builder: (context, snapshot) {
          ...
          final categoryLabel = _categoryLabel(product.category, t);
          final lastSync = DateTime.now().subtract(Duration(hours: product.id.hashCode.abs() % 30));
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          _InfoChip(label: t.productPrice, value: numberFormat.format(product.price)),
                          _InfoChip(label: t.productVariants, value: '${product.variantsCount}'),
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          _Tag(
                            label: product.lowStock ? t.productMetaStockLow : t.productMetaStockHealthy,
                            highlight: product.lowStock,
                          ),
                        ],
                      ),
                      const SizedBox(height: 16),
...
void _showEditPlaceholder(BuildContext context) {
  ...
  ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(content: Text(t.editComingSoon)),
  );
}
